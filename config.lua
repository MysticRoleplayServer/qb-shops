...
Config.Products = {
    ...
    ["blackmarket4"] = {
        { name = "scales", price = 300, amount = 25 }, -- envi-trap-phone
    ...
    ['ambulance'] = {
        ...
        { name = 'healthmonitor',           price = 75,  amount = 50 },
        { name = 'weapon_flashlight',       price = 75,  amount = 5 },
        { name = 'weapon_fireextinguisher', price = 50,  amount = 15 },
        { name = 'prescription_pad',        price = 50,  amount = 15 },
    },
    ['sadot'] = {
        { name = 'towremote',            price = 500,  amount = 100 },
        { name = 'mechanic_tablet',      price = 100,  amount = 100 },
        { name = 'cleaning_kit',         price = 200,  amount = 100 },
        { name = 'repair_kit',           price = 300,  amount = 100 },
        { name = 'duct_tape',            price = 50,   amount = 100 },
